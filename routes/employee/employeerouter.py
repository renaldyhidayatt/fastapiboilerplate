...
async def updateEmployee(id:int, request: EmployeeEntity):
    ...
    return Response(content=f"Update Employee berdasarkan {id}", status_code=status.HTTP_200_OK)
...
async def deleteEmployee(id: int):
    ...
    return Response(content=f"Delete Employee berdasarkan {id}", status_code=status.HTTP_200_OK)
